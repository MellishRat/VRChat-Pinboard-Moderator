...
8\. Optionally customise `flagged\_words.json`.
...
py -m PyInstaller pinboard\_moderator\_gui.spec --clean
...
dist/VRChat\_Pinboard\_Moderator.exe
...
Unofficial desktop moderation tool for Oikki's Memo Bulletin Board VRChat asset.
...
8\. `flagged\_words.json` を編集して独自のルールを設定できます。
